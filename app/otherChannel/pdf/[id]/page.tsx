        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center items-center gap-4 mt-8">
            ...
            >
              ...
              <Link href="/otherChannel/pdf" className="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium text-lg rounded-lg hover:bg-gray-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
>
                ފަހަތަށް
