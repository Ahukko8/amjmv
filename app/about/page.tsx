      ...
      <section className="py-12 sm:py-16 bg-[#F5F5F5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg text-[#121212] max-w-3xl mx-auto">
          ...
          >
            {/* Achievement Card 1 */}
            <div className="bg-[#F5F5F5] rounded-xl shadow-md p-6 hover:shadow-xl transition-shadow duration-300 border border-[#121212]/20">
              <div className="h-12 w-12 bg-[#121212]/80 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <h3 className="text-xl font-semibold text-center text-[#121212] mb-2">ޢިލްމީ ލިޔުންތައް އެކުލަވާލެއްވުން</h3>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#F5F5F5]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-semibold text-center text-[#121212] mb-2">ދަރުސްތައް</h3>
              <p className="text-[#121212] text-center">
            ...
            <div className="h-12 w-12 bg-[#121212]/80 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <h3 className="text-xl font-semibold text-center text-[#121212] mb-2">ބައިނަލްއަޤްވާމީ ދަޢުވަތު</h3>
              <p className="text-[#121212] text-center">
